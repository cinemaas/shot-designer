...
import { drawCar, FOURRUNNER, SEATS, SEATED_PELVIS } from "./car.js?v=4b38ac57";
import { UNITS_PER_FOOT, HAND_PROPS, LOOKED_AT } from "./catalog.js?v=4b38ac57";

export { HAND_PROPS, LOOKED_AT, FOURRUNNER, SEATS, SEATED_PELVIS };
import { fieldOfView } from "./optics.js?v=4b38ac57";
